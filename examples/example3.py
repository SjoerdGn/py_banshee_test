# -*- coding: utf-8 -*-
"""
Created on Sat Sep 25 13:06:14 2021
...
R = bn_rankcorr(parent_cell,        # structure of the BN
                data,               # matrix of data
                is_data = 1,        # matrix data contains actual data
                plot = 1,           # create a plot (0 = don't create plot)
...
# draw 500 samples of the normal distribution and perform 1000 iterations to
