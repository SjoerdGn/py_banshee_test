# -*- coding: utf-8 -*-
"""
Created on Wed Aug 18 15:06:10 2021
This code reproduce the non-parametric Bayesian network and the sample based contiong 
...
D_ERC,B_ERC,D_BNRC,B_BNRC = gaussian_distance(R,                   # rank correlation matrix (function 1)
                                              ...
                                              'H',                 # type of distance metric (H = Hellinger distance)
                                              'd_cal_bridge')      # plot name
...
samples = generate_samples(data,R,n=no_samples)  
